...
template<typename T> class Optional {
 public:
  ...
  bool operator==(const T &value) const { return this->hasValue_ && this->value_ == value; }
  bool operator!=(const T &value) const { return !this->hasValue_ || this->value_ != value; }
  friend bool operator!=(const T &value, const Optional<T> &opt) { return !opt.hasValue_ || opt.value_ != value; }
